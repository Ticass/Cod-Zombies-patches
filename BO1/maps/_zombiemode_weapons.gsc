...
patch_kino()
{
	...
	//T-Gun
	if(!self has_weapon_or_upgrade("thundergun_zm") && !any_player_has_weapon("thundergun_zm"))
		return "thundergun_zm";

	//Monkeys
	if(!self has_weapon_or_upgrade("zombie_cymbal_monkey"))
	...
	//Crossbow for coop or solo
	if(!self has_weapon_or_upgrade("crossbow_explosive_zm") && !any_player_has_weapon("crossbow_explosive_zm"))
...
has_kino_weapons()
{
//Fix box not returning weapons after picking up all the guns
	if(self has_weapon_or_upgrade("thundergun_zm") && any_player_has_weapon("thundergun_zm") && all_players_have_weapon("zombie_cymbal_monkey") && self has_weapon_or_upgrade("ray_gun_zm"))
		return true;
}
...
has_five_weapons()
{
	if(self has_weapon_or_upgrade("crossbow_explosive_zm") && any_player_has_weapon("crossbow_explosive_zm") && all_players_have_weapon("zombie_cymbal_monkey") && self has_weapon_or_upgrade("ray_gun_zm"))
		return true;
}
...
patch_ascension()
{
	...
	//Gersh
	if (!self has_weapon_or_upgrade("zombie_black_hole_bomb"))
...
has_ascension_weapons()
{
	if(self has_weapon_or_upgrade("crossbow_explosive_zm")  && any_player_has_weapon("crossbow_explosive_zm") && self has_weapon_or_upgrade("zombie_black_hole_bomb") && self has_weapon_or_upgrade("thundergun_zm") && any_player_has_weapon("thundergun_zm") && self has_weapon_or_upgrade("ray_gun_zm"))
			return true;
}
...
{
	//Scavenger
	if(!self has_weapon_or_upgrade("sniper_explosive_zm") && !any_player_has_weapon("sniper_explosive_zm"))
	...
	//Russian Dolls
	if(!self has_weapon_or_upgrade("zombie_nesting_dolls") && !any_player_has_weapon("zombie_nesting_dolls"))
...
has_cotd_weapons()
{
		if(self has_weapon_or_upgrade("sniper_explosive_zm") && any_player_has_weapon("sniper_explosive_zm") && self has_weapon_or_upgrade("ray_gun_zm") && self has_weapon_or_upgrade("zombie_nesting_dolls") && any_player_has_weapon("zombie_nesting_dolls") && self has_weapon_or_upgrade("crossbow_explosive_zm") && any_player_has_weapon("crossbow_explosive_zm"))
				return true;
}
...
{	
	//BabyGun
	if(!self has_weapon_or_upgrade("shrink_ray_zm") && !any_player_has_weapon("shrink_ray_zm"))
...
has_shang_weapons()
{
	if(self has_weapon_or_upgrade("crossbow_explosive_zm")  && any_player_has_weapon("crossbow_explosive_zm") && self has_weapon_or_upgrade("zombie_cymbal_monkey") && self has_weapon_or_upgrade("ray_gun_zm") && self has_weapon_or_upgrade("shrink_ray_zm") && any_player_has_weapon("shrink_ray_zm") )
			return true;
...
{	
	//WaveGun
	if(!self has_weapon_or_upgrade("microwavegundw_zm") && !any_player_has_weapon("microwavegundw_zm"))
...
has_moon_weapons()
{
	if(any_player_has_weapon("crossbow_explosive_zm") && self has_weapon_or_upgrade("zombie_black_hole_bomb") && self has_weapon_or_upgrade("ray_gun_zm") && self has_weapon_or_upgrade("microwavegundw_zm") && any_player_has_weapon("microwavegundw_zm"))
				return true;
}
...
has_nacht_weapons()
{
	if(self all_players_have_weapon("ray_gun_zm") && self has_weapon_or_upgrade("zombie_cymbal_monkey") && any_player_has_weapon("thundergun_zm"))
			return true;
}
...
{	
	//Waffe
	if(!self has_weapon_or_upgrade("tesla_gun_zm") && !any_player_has_weapon("tesla_gun_zm"))
		return "tesla_gun_zm";
	...
	//dual wield cz's
	if(!self has_weapon_or_upgrade("cz75dw_zm"))
		return "cz75dw_zm";
...
has_shino_weapons()
{
	if(all_players_have_weapon("ray_gun_zm") && self has_weapon_or_upgrade("cz75dw_zm") && self has_weapon_or_upgrade("zombie_cymbal_monkey") && any_player_has_weapon("tesla_gun_zm"))
				return true;
}
...
{	
	...
	//FreezeGun
	if(!self has_weapon_or_upgrade("freezegun_zm") && !any_player_has_weapon("freezegun_zm"))
		return "freezegun_zm";

	//rpk
	if(!self has_weapon_or_upgrade("rpk_zm"))
		return "rpk_zm";
}

has_verruckt_weapons()
{
	//FreezeGun
	if(any_player_has_weapon("freezegun_zm") && self has_weapon_or_upgrade("rpk_zm") && all_players_have_weapon("zombie_cymbal_monkey") && self all_players_have_weapon("ray_gun_zm"))
		return true;
}

patch_der()
{
	//Raygun once the box moved
	if(!self has_weapon_or_upgrade("ray_gun_zm"))
		return "ray_gun_zm";
...
has_der_weapons()
{
	if(self has_weapon_or_upgrade("crossbow_explosive_zm") && any_player_has_weapon("crossbow_explosive_zm") && any_player_has_weapon("tesla_gun_zm") && all_players_have_weapon("zombie_cymbal_monkey") && self all_players_have_weapon("ray_gun_zm"))
		return true;
}
...
treasure_chest_ChooseWeightedRandomWeapon( player )
{
	...
	{
			//Kino
		if (level.script == "zombie_theater" && !has_kino_weapons())
			return player patch_kino();

		//Five
		if (level.script == "zombie_pentagon" && !has_kino_weapons())
			return player patch_five();

		//Ascension
		if (level.script == "zombie_cosmodrome" && !has_ascension_weapons())
			return player patch_ascension();

		//Call of the dead
		if (level.script == "zombie_coast" && !has_cotd_weapons())
			return player patch_cotd();

		//Shang
		if (level.script == "zombie_temple" && !has_shang_weapons())
			return player patch_shang();

		//Moon
		if (level.script == "zombie_moon" && !has_moon_weapons())
			return player patch_moon();

		//Nacht
		if (level.script == "zombie_cod5_prototype" && !has_nacht_weapons())
			return player patch_nacht();

		//Verrukt
		if (level.script == "zombie_cod5_asylum" && !has_verruckt_weapons())
			return player patch_verrukt();

		//Shi-no
		if (level.script == "zombie_cod5_sumpf" && !has_shino_weapons())
			return player patch_shino();

		//Der Riese
		if (level.script == "zombie_cod5_factory" && !has_der_weapons())
			return player patch_der();
	}
